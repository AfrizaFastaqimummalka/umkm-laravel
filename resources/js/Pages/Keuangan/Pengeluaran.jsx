...
export default function Pengeluaran({ items, total, bulan, tahun }) {
    ...
    const handleUpdate = (e) => {
        e.preventDefault();
        put(`/pengeluaran/${selectedItem.id}`, {
        ...
        <AppLayout>
            <div className="page-header">
                <div>
                    ...
                    <p className="page-sub">{items.length} transaksi — Total: <strong className="tr">Rp {total.toLocaleString('id-ID')}</strong></p>
                </div>
                        ...
                        <tbody>
                            {items.map((item) => (
                                <tr key={item.id}>
                                    ...
                                    <td>
                                        <span className={`badge ${item.kategori === 'bahan_baku' ? 'badge-red' : (item.kategori === 'gaji' ? 'badge-amber' : 'badge-gray')}`}>
                                            {item.kategori_label}
                                        </span>
                                    </td>
                                ...
                                <tr>
                                    <td colSpan="5">
                                        <div className="empty">
                                            ...
                                            <p className="empty-ttl">Belum ada data pengeluaran</p>
                                        </div>
                                    </td>
                                </tr>
                            )}
                ...
                <div className="modal-overlay open">
                    <div className="modal">
                        <div className="modal-header">
                            <h3 className="modal-title">Tambah Pengeluaran</h3>
